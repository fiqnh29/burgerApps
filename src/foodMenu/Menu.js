            ...
            return(
                <Link to={`/menu-detail?id=${val.id}`}>
                    <div className='cardBox'>
                        ...
                        <div class="middle">
                            <h1 className='text menu-price'>{val.menuType} Menu</h1>
                        </div>
                        {/* <h1 className='menu-price'>Rp. {val.price.toLocaleString()}</h1> */}
                    </div>
                </Link>
    ...
    renderMenuList=()=>{
        // return this.state.data.map((val1)=>{
            ...
            return(
                ...
                <MDBNavItem  >
                    <Link to={`/menu-classic`}><h3 className='Menu-nav-item'>Classic</h3></Link>
                </MDBNavItem>
                <MDBNavItem>
